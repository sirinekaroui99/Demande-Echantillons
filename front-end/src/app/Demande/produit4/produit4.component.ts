...
@Component({
  selector: 'app-produit4',
  templateUrl: './produit4.component.html',
  styleUrls: ['./produit4.component.css']
})
export class Produit4Component implements OnInit {

 
  options! : Produit[];
  tab = new Array();

  @Output() commande4: Commande = {
    Num_cmd : 0,
    Date_cmd :new Date(),
    Produit : '',
    Quantite : 0,
